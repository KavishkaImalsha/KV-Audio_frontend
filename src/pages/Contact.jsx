                        ...
                        <form>
                            <div className="grid grid-cols-2 gap-2 mb-5">
                                <div>
                                    ...
                                    <input type="text" name="name" className="w-full h-10 px-3 border border-gray-300 focus:outline-0" required/>
                                </div>
                                <div>
                                    <label htmlForfor="email" className="block">Your Email</label>
                                    <input type="text" name="email" className="w-full h-10 px-3 border border-gray-300 focus:outline-0" required/>
                                </div>
                            </div>
                            <div className="mb-5">
                                <label htmlForfor="phone" className="block">Mobile number</label>
                                <input type="number" name="phone" className="w-[50%] h-10 px-3 border border-gray-300 focus:outline-0" required/>
                            </div>
                            <div className="mb-5">
                                <label htmlForfor="subject" className="block">Subject</label>
                                <select className="w-full h-10 px-3 border border-gray-300 focus:outline-0">
                            ...
                            <div>
                                ...
                                <textarea name="message" className="w-full h-56 py-3 px-3 border border-gray-300 focus:outline-0" required/>
                            </div>
